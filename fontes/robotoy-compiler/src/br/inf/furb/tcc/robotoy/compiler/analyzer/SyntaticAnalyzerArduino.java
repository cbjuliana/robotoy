...
public class SyntaticAnalyzerArduino implements Constants, GenericSyntaticAnalyzer
{
    ...
    /* (non-Javadoc)
     * @see br.inf.furb.tcc.robotoy.compiler.analyzer.teste#parse(br.inf.furb.tcc.robotoy.compiler.analyzer.LexicalAnalyzer, br.inf.furb.tcc.robotoy.compiler.analyzer.GenericSemanticAnalyzer)
     */
    @Override
